<?php
    ...
    if(isset($_GET['download']))
    {
        ...
        LEFT JOIN topic_table AS t ON i.topicID = t.topicID WHERE ideaID='$ID'"); 
        ...
        if($query->num_rows > 0){ 
            ...
            //Set column headers 
            $fields = array('Idea ID', 'Topic', 'Title', 'Description', 'Category', 'User ID', 
            'Department', 'Start_Date', 'End_Date', 'Final_Closure_Date', 'TnC'); 
